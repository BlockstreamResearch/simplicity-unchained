//! For testing interaction with SimplicityHL
...
pub fn get_opcode_from_script(
    dst: &mut CFrameItem,
    src: CFrameItem,
    env: &BitcoinUnchainedEnv,
) -> bool {
...
register_jets!(
    ...
    "get_opcode_from_script" => get_opcode_from_script, b"c", b"c",
    "get_pubkey_from_script" => get_pubkey_from_script, b"c", b"h",
);
